...
- [AI-landing-page-](https://github.com/Zubair-hussain/AI-landing-page-) - Snapmind – A stunning AI-powered product photography SaaS landing page built with Next.js 14, TypeScript, GSAP, and Three.js. Features smooth scroll animations, interactive before/after slider, custom cursor, and a mesmerizing particle background. `JavaScript`
- [cold-email-skill](https://github.com/Zubair-hussain/cold-email-skill) - AI-powered cold email generator for high-converting outreach. Built for Claude Skills using proven frameworks (plain-text, problem-based, anti-spam). Stars: 1
- [Forever-Space](https://github.com/Zubair-hussain/Forever-Space) - No description yet `HTML`
<!--END_SECTION:repos-->
